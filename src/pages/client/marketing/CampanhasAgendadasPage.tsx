...
export default function CampanhasAgendadasPage() {
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Visualize e gerencie campanhas programadas para o futuro
          </CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-sm text-muted-foreground">
            Esta página está em desenvolvimento. Em breve você terá acesso às 
            funcionalidades completas de campanhas agendadas.
          </p>
        </CardContent>
      </Card>
